...
В результате автоматизации - весь процесс занимает мене 2 минут (это можно посмотреть на [Скриншот 3: Логи работы в консоли](assets/console_logs.png) -  Логи работы в консоли)
